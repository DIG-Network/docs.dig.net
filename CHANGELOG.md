...
### Bug Fixes
- **protocol:** Canonical relay endpoint is wss://relay.dig.net:443, not :9450 (#82)
...
### Documentation
- **protocol:** Document DIG_NODE_FORWARD_ON_MISS forwarded-ask gate (#76)

## [0.16.0] - 2026-08-09

### Documentation
- Document wallet chain-read control methods (#71)

## [0.15.0] - 2026-08-06

### Documentation
- **protocol:** Document the content-miss wire contract (-32008 capped / -32003 / proxy:) (#2192)
...
### Documentation
- **run-a-node:** Document which source answered a wallet balance read (#68)

## [0.13.0] - 2026-08-06

### Documentation
- **protocol:** Document uniform server-side chain-anchor enforcement on dig.fetchRange (#67)

## [0.12.2] - 2026-08-06

### Documentation
- **rpc:** Catalog the dig.getMetadata response ceiling error -32015 (#66)
...
### Documentation
- **cli:** The node ladder prefers your own node, and mTLS is not yet wired (#61)

## [0.11.4] - 2026-08-05

### Documentation
- **run-a-node:** Note the installer auto-provisions local HTTPS trust
...
### Documentation
- **rpc:** Large-capsule 413 → dig.getCapsule chunk loop on the §21 remote (#62)

## [0.11.1] - 2026-08-03

### Chores
- **test:** Fix test:unit to run on Node 22+ (#2069)

## [0.11.0] - 2026-08-03

### Documentation
- **cli-tools:** Add a DIG CLI tools overview section (#683)

## [0.10.1] - 2026-08-03

### Documentation
- **readme:** Document the i18n install-page-mirror and English-only-link gotchas (#2058)

## [0.10.0] - 2026-08-03

### Documentation
- **run-a-node:** Document the https://dig.local local-HTTPS endpoint (#658)

## [0.9.0] - 2026-08-03

### Documentation
- **rpc:** Document control.wallet.balance RPC, CLI verb and -3204x errors (#1958)
...
### Documentation
- Dig-app recovery-phrase onboarding + DHT discovery-granularity coherence (#53)

## [0.7.4] - 2026-07-30

### Chores
- **docs.dig.net:** Drop unused @docusaurus/plugin-client-redirects dep (#268)
...
### Documentation
- Add CLAUDE.md documenting the machine-spec drift gate (#1666)

## [0.7.0] - 2026-07-26

### Documentation
- **protocol:** Publish the paged range-frame metadata split and -32009 (#48)

## [0.6.0] - 2026-07-26

### Documentation
- **protocol:** Real-time capsule-holder discovery (find_providers + holdings-announce) (#47)
...
### Documentation
- **run-a-relay:** Document relay operator config knobs (14 locales) (#45)

## [0.5.1] - 2026-07-19

### Chores
- **links:** Repoint dig-store repo links to DIG-Network/digs (#764) (#44)
