...
| `-32011`–`-32014` | **Capsule staging errors** (`dig.stage`, local control): `-32011` source directory unreadable; `-32012` no files to stage; `-32013` content exceeds the capsule size cap; `-32014` a compile/IO failure building the module. | Confirm the directory exists, is readable, non-empty, and within the size cap; re-run. |
