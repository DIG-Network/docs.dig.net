...
description: "Mint a whole CHIP-0007 collection whose art lives permanently in a tamper-evident DIG capsule — one atomic signed bundle, real royalties, and honest drop mechanics that never fake what they can't yet prove on-chain."
keywords:
  - mint NFT Chia
...
Spends are **never hand-rolled**: the canonical CHIP-0035 wasm builder (via [`@dignetwork/dig-sdk/spend`](../sdk.md)) builds every coin spend, your wallet signs once, and it broadcasts once.
