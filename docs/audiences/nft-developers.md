...
Trade NFTs for XCH or CATs with `digs offer make | take | show` (each `--dry-run` / `--json`). → [Command reference](../digstore/cli/command-reference.md)
