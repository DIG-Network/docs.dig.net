...
slug: /
title: DIG Network
description: "Vue d'ensemble des primitives du DIG Network : DigStore pour la publication adressable par contenu, le dig RPC pour l'hébergement et la récupération à l'aveugle, et le DIG Browser pour l'accès au contenu."
keywords:
  - DIG Network
...
→ **[Explorer DigStore](./digstore/what-is-digstore.md)**

| | |
|---|---|
| **[Qu'est-ce que DigStore ?](./digstore/what-is-digstore.md)** | L'idée en un fichier, en un mot |
| **[Le format](./digstore/format/overview.md)** | Projets, déploiements, URN, chiffrement, preuves |
| **[Tutoriel CLI](./digstore/cli/quickstart.md)** | Installer et utiliser `digstore` dans votre projet |
...
:::note
DIG Network et ses primitives sont open source. DigStore est sous licence GPL-2.0 ; voir le [dépôt digstore](https://github.com/DIG-Network/digstore).
:::
...
- [Qu'est-ce que DigStore ?](./digstore/what-is-digstore.md) — le format de store adressable par contenu
