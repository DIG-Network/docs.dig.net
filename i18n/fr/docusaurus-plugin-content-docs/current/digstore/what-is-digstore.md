...
# Qu'est-ce que DigStore ? {#what-is-digstore}
...
- **[Le format DigStore](./format/overview.md)** — les concepts : projets, déploiements, le module `.wasm`, les URN, le chiffrement, et les preuves. Commencez ici si vous voulez comprendre *ce qu'est* DigStore.
...
:::note
DigStore fait partie du [DIG Network](https://dig.net). La conception technique complète se trouve dans la [section Protocole](../protocol-deep-dive.md) — le format de store WASM adressable par contenu.
:::

## Voir aussi {#related}

- [Le format DigStore](./format/overview.md) — projets, module WASM, URN, chiffrement, preuves
