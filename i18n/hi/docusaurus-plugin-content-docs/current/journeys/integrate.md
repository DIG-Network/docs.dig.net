...
Wire `dig-network/deploy-action` for push-to-publish with free PR previews, or drive `digs deploy` yourself. Authorize CI with a revocable **deploy key**, not your wallet seed.
