...
- **[O formato DigStore](./format/overview.md)** — os conceitos: projetos, deployments, o módulo `.wasm`, URNs, criptografia e provas. Comece aqui se você quer entender *o que* é a DigStore.
...
:::note
A DigStore faz parte da [DIG Network](https://dig.net). O design técnico completo está na seção [Protocolo](../protocol-deep-dive.md) — o formato de store WASM endereçável por conteúdo.
:::

## Relacionados {#related}

- [O formato DigStore](./format/overview.md) — projetos, o módulo WASM, URNs, criptografia, provas
