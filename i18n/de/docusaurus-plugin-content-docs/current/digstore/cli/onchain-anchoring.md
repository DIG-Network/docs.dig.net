...
description: "Wallet seed setup, on-chain costs, funding, anchor status, and chain-verified downloads for digs projects."
keywords:
  - on-chain anchoring
  - Chia singleton
  - wallet seed
...
| Operation | $DIG | XCH |
|---|---|---|
| `digs init` (mint the first capsule) | **the capsule price** | small mainnet fee |
| `digs commit` (publish a new capsule) | **the capsule price** | small mainnet fee |
