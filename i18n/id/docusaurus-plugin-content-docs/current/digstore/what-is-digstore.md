...
- **[Format DigStore](./format/overview.md)** — konsepnya: proyek, deployment, modul `.wasm`, URN, enkripsi, dan proof. Mulai di sini jika Anda ingin memahami *apa* itu DigStore.
...
:::note
DigStore adalah bagian dari [DIG Network](https://dig.net). Desain teknis lengkapnya ada di bagian [Protokol](../protocol-deep-dive.md) — format store WASM content-addressable.
:::

## Terkait {#related}

- [Format DigStore](./format/overview.md) — proyek, modul WASM, URN, enkripsi, proof
